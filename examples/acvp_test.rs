...
fn main() {
    ...
    let expected_rho = [
        0x00, 0x68, 0x77, 0x35, 0x26, 0x23, 0xcc, 0xdb, 0x31, 0xc7, 0xd3, 0x82, 0xa6, 0x46, 0x98,
        0x3d, 0xea, 0xbc, 0x4d, 0x3a, 0xf7, 0x3c, 0x9a, 0x66, 0x84, 0x19, 0xae, 0x56, 0x78, 0x71,
        0x34, 0xa9,
    ];

    let expected_k = [
        0x06, 0x4d, 0x04, 0xd7, 0xf0, 0xdf, 0x1b, 0xa0, 0xed, 0xcc, 0xfc, 0x2b, 0x82, 0x51, 0xaf,
        0xa5, 0x71, 0xe7, 0x7b, 0x7a, 0x3b, 0xc0, 0xfc, 0x88, 0xf0, 0x29, 0x60, 0x34, 0xa2, 0x36,
        0x17, 0xa3,
    ];

    let expected_tr_prefix = [
        0x4b, 0x41, 0xa1, 0x27, 0xfc, 0x5d, 0x2d, 0xf5, 0xae, 0xc8, 0x5e, 0x0a, 0x77, 0x0a, 0xb4,
        0xb0,
    ];
    ...
    match Dilithium5::sign(&sk, test_msg) {
        Ok(sig) => match Dilithium5::verify(&pk, test_msg, &sig) {
